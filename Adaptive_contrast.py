# -*- coding: utf-8 -*-
""" Created on Wed Mar 11 20:20:47 2020 @author: 不用先生 """
import numpy as np
import cv2
...
def main():
    ...
    cv2.imwrite('contrast-result/'+img+'_contrast.jpg', dstimg)
    cv2.imshow(dstimg,"contrast")
    cv2.waitKey(0)

    return 0


input_fn = '../test-image/3569.JPG'
